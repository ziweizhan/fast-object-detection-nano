...
img_dim = 300
p = 0.5
train_sets = [('2007', 'person_trainval')]
cfg = VOC_Config
...
net = build_net('train', img_dim, num_classes=3)
...
criterion = MultiBoxLoss(num_classes=3,
                         overlap_thresh=0.4,
...
def train():
    ...
    stepvalues = (250 * epoch_size, 350 * epoch_size, 500 * epoch_size)
    step_index = 0
    start_iter = 0
