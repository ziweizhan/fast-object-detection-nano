...
def multibox(num_classes=2):
    ...
    ############################ 第5个检测层 ############################
    loc_layers  += [nn.Conv2d(128, anchor_num[4] * 4, kernel_size=3, padding=1)]
    conf_layers += [nn.Conv2d(128, anchor_num[4] * num_classes, kernel_size=3, padding=1)]
    ############################ 第6个检测层 ############################
    loc_layers  += [nn.Conv2d(64, anchor_num[5] * 4, kernel_size=3, padding=1)]
    conf_layers += [nn.Conv2d(64, anchor_num[5] * num_classes, kernel_size=3, padding=1)]
